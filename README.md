...
На iPhone PWA устанавливается **только через Safari** — Chrome и другие браузеры не поддерживают добавление на главный экран.

1. Откройте [trip-ledger-omega.vercel.app](https://trip-ledger-omega.vercel.app) в **Safari**
...
Иконка появится на главном экране. Приложение откроется в полноэкранном режиме без панели браузера.
